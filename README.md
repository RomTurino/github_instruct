...
![Установка с помощью терминала](https://selectel.ru/blog/wp-content/uploads/2022/07/image28.png)
...
![Версия git](https://selectel.ru/blog/wp-content/uploads/2022/07/image8-1.png)

#### **Windows**
На винду Git можно скачать с [официального сайта](https://git-scm.com/download/win) или через пакет [Git Chocolatey](https://community.chocolatey.org/packages/git). Дополнительная информация о Git Windows доступна по [ссылке](https://gitforwindows.org/).
