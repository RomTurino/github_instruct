...
Со списком комманд и более подробным описанием ты можешь ознакомиться на сайте Гитхаба. Или просто тыкни [вот прям сюда](https://training.github.com/downloads/ru/github-git-cheat-sheet/).
...
*git commit -m "my comment about changes"*
