...
Github изменил порядок цен. Если раньше было несколько тарифов, то теперь остался только один тариф который равен **7 usd**
Для организаций тоже поменялись тарифы. Для организации стоит теперь  ** 25 usd для 5 человек** и **9 usd для кажого нового человека**
